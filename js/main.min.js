$(document).ready(function () {
  ...
  function c() {
    if (d) {
      ...
      window.addEventListener(e, _.throttle(o, 60), !1),
        $(
          ".indicate-dots li a, .btn[href*='#'], .main-menu a:not(.external)"
        ).click(function () {
          return (
            (n = $($(this).attr('href')).index()),
            $('.page').removeClass('current'),
            $($(this).attr('href'))
              .removeClass('down-scroll up-scroll')
              .addClass('current'),
            $('.indicate-dots li, .main-menu li').removeClass('current'),
            $(
              ".indicate-dots li [href='" +
  ...
  $(window).width() > 1023 && $(window).height() > 720 && (a || (d = !0)),
    ...
    $('.reviews-slider').slick({
      ...
      speed: 400,
      nextArrow:
        '<button type="button" class="slick-next"><i class="fa fa-chevron-right" aria-hidden="true"></button>',
      prevArrow:
        '<button type="button" class="slick-prev"><i class="fa fa-chevron-left" aria-hidden="true"></button>',
    }),
    $('.chef-slider').slick({
      dots: !1,
      infinite: !1,
